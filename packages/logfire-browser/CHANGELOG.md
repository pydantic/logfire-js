...
- Updated dependencies [8cd4707]
  - @pydantic/logfire-session-replay@0.4.0
...
- Updated dependencies [8f6c307]
- Updated dependencies [8e2d6b3]
- Updated dependencies [00c584f]
- Updated dependencies [396b738]
- Updated dependencies [bf2df6d]
- Updated dependencies [a8d2736]
  - logfire@0.22.3
...
- 08df271: Stop emitting the duplicate `browser.session.id` span attribute. Browser spans and session replays continue to correlate through `session.id`; spans recorded in full or buffer mode retain the `logfire.session_replay.active` and `logfire.session_replay.mode` markers.
...
- Updated dependencies [5c2bd73]
- Updated dependencies [c188c07]
- Updated dependencies [487eaa8]
  - logfire@0.21.10
  - @pydantic/logfire-session-replay@0.3.1
...
- Updated dependencies [44cd981]
  - @pydantic/logfire-session-replay@0.2.0
  - logfire@0.21.4
