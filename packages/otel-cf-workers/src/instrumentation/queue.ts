...
export async function executeQueueHandler(queueFn: QueueHandler, [batch, env, ctx]: QueueHandlerArgs): Promise<void> {
...
export function createQueueHandler(queueFn: QueueHandler, initialiser: Initialiser): QueueHandler {
...
export function instrumentQueueSender(queue: Queue, name: string): Queue {
