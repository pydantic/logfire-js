import type { SpanOptions, Exception } from '@opentelemetry/api'
...
let cold_start = true
export async function executeScheduledHandler(scheduledFn: ScheduledHandler, [controller, env, ctx]: ScheduledHandlerArgs): Promise<void> {
...
export function createScheduledHandler(scheduledFn: ScheduledHandler, initialiser: Initialiser): ScheduledHandler {
